...
import { RegisterForm } from "../resources/auth/registerForm";
...
function Register() {
  return (
    <div
      className={
        "w-screen md:h-screen overflow-y-auto flex flex-col-reverse md:flex-row gap-6 md:gap-0"
      }
    >
      <div
        className={
      ...
      >
        <h2 className={"self-start font-bold text-xl md:text-2xl lg:text-3xl"}>
          S&rsquo;inscrire
        </h2>
        <RegisterForm />
      </div>
...
Register.getLayout = function getLayout(page: ReactElement) {
  return <RegularLayout headerProps={{ white: true }}>{page}</RegularLayout>;
};
