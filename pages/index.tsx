...
const Home = () => {
    ...
    return (
        <>
            <Meta title={"Metz Numeric Game : Bienvenue !"} description={""} url={router.basePath} />
            <div
                className={
                    "flex justify-center items-center w-screen h-screen relative px-8 md:px-16 pt-[136px] overflow-hidden"
                }
            >
                <div className={"flex flex-col lg:w-3/4 h-fit flex-1 gap-6 md:gap-12 text-white lg:text-neutral"}>
