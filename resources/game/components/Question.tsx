...
const Question = observer(() => {
  ...
  return (
    <div className={"px-8 py-12 flex flex-col justify-between h-full"}>
      ...
      <div className={"flex flex-wrap gap-8"}>
        {
          question.answers.map((answer, index) => {
            return <Answer key={answer.text} text={answer.text} checked={checkedQuestion.includes(index)}
                           onClick={() => {

                             if (checkedQuestion.includes(index)) {
                               setCheckedQuestion(checkedQuestion.filter(questionIndex => questionIndex !== index));
                             } else {
      ...
      <div className={"absolute right-8 top-1/2 hover:cursor-pointer hover:scale-110 transition-all active:scale-100"}>
        <svg width="67" height="55" viewBox="0 0 67 55" fill="none" xmlns="http://www.w3.org/2000/svg"
          ...
          <rect x="66.9216" width="32.4424" height="32.4424" transform="rotate(90 66.9216 0)" fill="url(#pattern1)" />
          <rect x="66.9216" y="22.5576" width="32.4424" height="32.4424" transform="rotate(90 66.9216 22.5576)"
                fill="url(#pattern2)" />
          <defs>
            <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1" height="1">
              <use xlinkHref="#image0_709_191"
            ...
            <image id="image0_709_191" width="320" height="64"
            ...
            <image id="image1_709_191" width="128" height="128"
            ...
            <image id="image2_709_191" width="128" height="128"
