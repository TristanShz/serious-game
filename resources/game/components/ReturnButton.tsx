    ...
    <>
      {
        ...
        <>
          ...
          <div
            className={"px-8 py-12 flex flex-col justify-center gap-8 absolute w-1/3 z-50 bg-quizz-background top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-2xl shadow-xl"}>
            <p>Êtes-vous sur de vouloir quitter le test en cours ? votre progression ne sera pas enregistrée et vous ne
              pourrez pas repasser ce test avant <strong>14 jours</strong>.</p>
            <div className={"flex justify-between"}>
              <Button content={"Oui, je veux quitter"} color={"primary"} secondary onClick={() => router.back()} />
      ...
      <div
        className={"bg-quizz-background shadow-xl absolute z-10 left-4 bg-white p-3 rounded-b-full hover:cursor-pointer"}
        onClick={() => {
