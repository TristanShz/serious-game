export default function SideBar() {
    return (
        <div className="flex flex-col justify-between h-screen bg-white border-r w-80">
                ...
                <nav className="flex flex-col mt-6 space-y-1">
                    ...
                    <details className="group">
                        <summary className="flex items-center px-4 py-2 text-gray-500 rounded-lg cursor-pointer hover:bg-gray-100 hover:text-gray-700">
                            ...
                            <span className="ml-3 text-sm font-medium"> Utilisateurs </span>
                        ...
                        <nav className="mt-1.5 ml-8 flex flex-col">
                            ...
                            >
                                ...
                                <span className="ml-3 text-sm font-medium"> Liste des utilisateurs </span>
                            </a>
                            ...
                            >
                                ...
                                <span className="ml-3 text-sm font-medium"> Résultats </span>
                            </a>
                        </nav>
                    </details>
                    ...
                    >
                        ...
                        <span className="ml-3 text-sm font-medium"> Catégories </span>
                    </a>
                    ...
                    >
                        ...
                        <span className="ml-3 text-sm font-medium"> Formations </span>
                    </a>
                    ...
                    <details className="group">
                        <summary className="flex items-center px-4 py-2 text-gray-500 rounded-lg cursor-pointer hover:bg-gray-100 hover:text-gray-700">
                            ...
                            <span className="ml-3 text-sm font-medium"> Quizz </span>
